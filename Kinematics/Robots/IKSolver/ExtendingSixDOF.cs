...
{
    class ExtendingSixDOF : IKSolver
    {
        public ExtendingSixDOF()
        {
            ...
            DHparameters = new double[7, 5] { {   0,      0,      0,   0, (double)JointType.Rotation },
                                              ...
                                              {   0,      0,      0,   0, (double)JointType.Translation },
            ...
            MinMax[3] = new System.Windows.Point(0, 20);
            MinMax[4] = new System.Windows.Point(0, 155);
            MinMax[5] = new System.Windows.Point(-180, 180);
            MinMax[6] = new System.Windows.Point(-180, 180);

            Coupling = CouplingType.LouShoulder;
            OutputWorkspace = true;
            InvertForces = new bool[3] { true, true, false };
            OutputStrings = new string[8] { "Joint1", "Joint2", "Joint3", "Joint4", "Joint5", "FX", "FY", "FZ" };
            eps = 0.0001;
            BETA = 10;
            Lmin = 75;
            Lmax = 179.57;

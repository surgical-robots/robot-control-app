...
namespace remoteApiNETWrapper
{
    public static class VREPWrapper
    {
        ...
        //[DllImport("remoteApi.dll")]
        //public static extern simx_error simxGetObjectGroupData(int clientID, sim_object objectType, int dataType, out int handlesCount, out int[] handles, out int intDataCount, out int[] intData,
        //                                                        out int floatDataCount, out float[] floatData, out int stringDataCount, out string[] stringData, simx_opmode opmode);

        [DllImport("remoteApi.dll")]
        public unsafe static extern simx_error simxGetObjectGroupData(int clientID, sim_object objectType, int dataType, int* handlesCount, int** handles, int* intDataCount, int** intData,
                                                                int* floatDataCount, float** floatData, int* stringDataCount, char** stringData, simx_opmode opmode);
        ...
        [DllImport("remoteApi.dll")]
        public static extern simx_error simxPauseSimulation(int clientID, simx_opmode opmode);
    }
}